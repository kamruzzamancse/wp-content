...
<div class="property-container">
    <div class="property-list">
        ...
        <!-- Duplicate the property-item block below for more properties -->
...
<div class="documents-container">
    ...
    <div class="document-card">
        <div class="document-header">
            ...
            <div class="document-name">Lease Agreement.jpg</div>
        </div>
        <div class="document-size">2.3MB</div>
        <div class="document-info">Processed: 1 week ago</div>
