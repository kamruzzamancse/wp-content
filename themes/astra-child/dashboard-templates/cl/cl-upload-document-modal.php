...
<div id="cl-upload-document-modal" class="clup-modal-overlay">
    <div class="clup-box">
        ...
        <form id="cl-upload-document-form" class="clup-form" enctype="multipart/form-data">
            <input type="hidden" name="document_id" value="">
            <input type="hidden" name="client_id" value="">
            <input type="hidden" name="properties_id" value="">
            <input type="hidden" name="assigned_task_id" value="">
            ...
            <div class="clup-upload-box">
                <div class="clup-upload-content">
                    ...
                    <span id="cl-selected-file-name" style="display:block; margin-top:5px;"></span>
                </div>
            </div>
