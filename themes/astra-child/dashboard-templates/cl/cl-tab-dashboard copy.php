...
#notes-list li:hover,
.notes-preview-list li:hover,
#all-notes-list li:hover {
    background: #f9f9f9;
}
...
/* ===== NOTES PREVIEW LIST ===== */
.notes-preview-list {
    max-height: 600px; /* 3 notes approx height */
    overflow-y: auto;
}
...
.cld-send-btn {
    ...
    background: #4e6ef2; /* default solid background */
    color: #fff !important;
    border: 2px solid transparent; /* allows border change for outlined buttons */
    border-radius: 20px; /* merged from second style */
    cursor: pointer;
    font-size: 14px;
    transition: all 0.3s ease;
